''' 
    ESTE ARQUIVO PEGA AS 100 PALAVRAS MAIS CITADAS ENTRE AS TRÃŠS COLUNAS DE 
    TEXTO E AS SALVA COMO DATASET, CONTA AS REPETIÃ‡Ã•ES POR LINHA E NO FINAL
    JUNTA COM A TABELA DO COMEÃ‡O
'''
import pandas as pd
import operator
